...
<template>
    <div>
        <div class="bg-gray-300" v-if="props.modelValue">

            <div v-if="props.modelValue" @keydown.esc="close" class="relative z-10" aria-labelledby="modal-title"
                 aria-modal="true">

                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>


                <div class="fixed inset-0 z-10 overflow-y-auto custom-scrollbar" @click.self="close">
